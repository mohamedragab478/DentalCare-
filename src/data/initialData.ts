...
const DEFAULT_TEETH_MAP: Record<number, { id: number; status: any; lastTreatmentDate?: string; notes?: string }> = {
  ...
  26: { 
    ...
    notes: 'Composite filling applied to occlusal surface. Patient reported mild sensitivity pre-treatment, resolved post-procedure. Margin integrity good.' 
  },
